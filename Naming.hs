...
module Naming where
    ...
    (
      ...
      \(e, _) ->
        (
          second (Data_1 b) <$>
          case c of
            Branching_data_0 g h i j -> second (Branching_data_1 g h i) <$> naming_branches_0 a e j
            Plain_data_0 g h ->
              (
                second (Plain_data_1 g) <$>
                case h of
                  Algebraic_data_0 i -> second Algebraic_data_1 <$> naming_forms a i e
                  Struct_data_0 i -> second Struct_data_1 <$> naming_fields a i e)))
  ...
  naming_def_2 j a b =
    case a of
      ...
      Instance_2 f c d l g k e -> naming_patterns j g b >>= \(h, i) -> Instance_3 f c d l i k <$> naming_nameexprs j h e
  naming_default ::
    (
      Locations ->
      (String -> u -> Locations -> Err t) ->
      u ->
      String ->
  ...
  naming_expression_branch g a b =
    case a of
  ...
  naming_match_algebraic a (Match_Algebraic_0 b c d) e =
    naming_pats a c e >>= \f -> Match_Algebraic_1 b c <$> naming_expression a d f
  ...
  naming_match_modular :: String -> Match_Modular_0 -> Locations -> Err Match_Modular_1
  ...
  naming_matches_modular :: String -> [Match_Modular_0] -> Locations -> Err [Match_Modular_1]
  ...
  naming_pat :: String -> Pat -> Locations -> Err Locations
  naming_pat a (Pat b c) d =
    case c of
      Application_pat _ e -> naming_pats a e d
      Blank_pat -> Right d
      Name_pat e -> fst <$> naming_name a (Name b e) d
  naming_pats :: String -> [Pat] -> Locations -> Err Locations
  naming_pats a b c =
    case b of
      [] -> Right c
      d : e -> naming_pat a d c >>= naming_pats a e
